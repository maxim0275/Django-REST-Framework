...
Задание 3 Описаны CRUD для моделей курса и урока Для реализации CRUD для курса использован Viewsets Для реализации CRUD для урока использован Generic-классы
