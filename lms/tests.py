...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(name_course="Тест", description="Новое тестовое описание", owner=self.user)
        self.lesson = Lesson.objects.create(name_lesson="Урок для теста", course=self.course,
                                            description="Тестовое описание для урока",
    ...
    def test_lesson_retrieve(self):
        ...
        self.assertEqual(
            data.get("name_lesson"), self.lesson.name_lesson
        )
    ...
    def test_lesson_update(self):
        ...
        self.assertEqual(
            data.get("name_lesson"), "Обновлённый"
        )
    ...
    def test_validator(self):
        data = {
            "name_lesson": "Для проверки",
            "course": self.course.id,
            "video_link": "https://www.valid.com/"
        }
        url = reverse("lms:lessons_create")
...
class SubscriptionTestCase(APITestCase):
    def setUp(self):
        self.user = User.objects.create(email='test1@test.com', password="rty")
        self.client.force_authenticate(user=self.user)
        self.course = Course.objects.create(name_course="Новый курс", description="Описание для нового курса",
                                            owner=self.user)
